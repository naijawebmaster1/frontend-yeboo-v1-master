...
const people = [
  { date: '20th Aug. 2023', time: '10:34:21 PM', name: 'Airtime', amount: '₦10, 000', status: 'Completed' },
  { date: '20th Aug. 2023', time: '10:34:21 PM', name: 'Mobile Data', amount: '₦10, 000', status: 'Ongoing' },
  { date: '20th Aug. 2023', time: '10:34:21 PM', name: 'Electricity Bill', amount: '₦10, 000', status: 'Failed' },
  { date: '20th Aug. 2023', time: '10:34:21 PM', name: 'Cable Subscription', amount: '₦10, 000', status: 'Ongoing' },
  { date: '20th Aug. 2023', time: '10:34:21 PM', name: 'Mobile Data', amount: '₦10, 000', status: 'Ongoing' },
                ...
                {people.map((person) => (
                  <tr key={person.name} >
                    ...
                    <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-50">
                      <span
                        style={{
                          backgroundColor: person.status === 'Completed' ? '#EBF8F1' : person.status === "Ongoing" ? "#FFF6E6" : "#FDECEB",
                          color: person.status === 'Completed' ? '#33BB77' : person.status === "Ongoing" ? "#FFA500" : "#EE4139"
                        }}

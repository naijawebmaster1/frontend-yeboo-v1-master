        ...
        <section className="profile">
            ...
            <div className="infoHeading">
                ...
                <div
                    ...
                    style={{display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '10px', cursor: 'pointer', background: '#eaeaeb', borderRadius: '5px'}}>
            ...
            <div className="editInfoMedia">
                ...
                <div className="vipImages">
                    ...
                    <p> <a href="#" style={{ color: '#fff', fontSize: '12px', textAlign: 'center' }}>Remove Image</a></p>
                    </div>
                ...
                <div className="vipvideo bgImage" style={{ border: 'none' }}>
                    <FaVideo className='fa-video-camera'/>

                    <p> <a href="#" style={{ color: '#fff', fontSize: '18px', textAlign: 'center' }}>Remove Video</a></p>
                </div>
                </div>
            </div>
...
export default VipProfileWithImages;

                  ...
                  >
                    {
                      showClose && (
                        ...
                        <p></p>
                      <p className='text-center text-sm text-charleston font-bold'>{title}</p>
                      <div onClick={() => setOpen(!open)} className="row flex  items-center justify-end cursor-pointer ">
                        <p><GiCancel size={20} color='#292D32'/> </p>
                      </div>
                      </div>
                      )
                    }
